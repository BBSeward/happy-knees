...
export const useDetectPose = (videoRef: React.RefObject<HTMLVideoElement>, canvasRef: React.RefObject<HTMLCanvasElement>, poseLandmarker: any) => {
  const [parsedLandmarks, setParsedLandmarks] = useState<any>(null);
